# Concepto de variable en R y asignación básica.
...
grepl usa regex o regular expressions, (buena salida laboral)
...
\
length(jefe_hogar)
jefe_hogar$canasta <- list(x1="carne", x2="verdura", x3="leche", x4="ropa")
